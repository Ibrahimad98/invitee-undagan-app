/**
 * 🚀 PROD SEED — Minimal essential data for first production deploy
 *
 * This seed creates only what's needed for a clean production start:
 * - Admin user (verified, ready to go)
 * - Demo user (for showcase)
 * - 14 templates (all counters at 0)
 * - Contact settings (WhatsApp, Email, Instagram, etc.)
 * - 2 demo invitations with guests, RSVPs (for demo/showcase)
 * - 4 seed testimonials
 *
 * System settings (beta_mode, email_verification, etc.) are NOT seeded here —
 * they are auto-created by SettingsService.ensureDefaults() on app startup.
 *
 * Run: NODE_ENV=production npx prisma db seed
 *   or: pnpm run db:seed:prod
 */
...
export async function seedProd() {
  console.log('🚀 Starting PRODUCTION seed (essential data only)...\n');
  ...
  // ═══════════════════════════════════════════════════════════
  // 🎨 Templates — All 14, counters at 0
  // ═══════════════════════════════════════════════════════════
  ...
  const templates = await Promise.all([
    prisma.template.create({ data: { name: 'Super Classic',    slug: 'super-classic',    thumbnailUrl: '/images/templates/super-classic.svg',    category: 'elegan',    tags: ['elegan','formal','classic','gold'],                              supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','KHITANAN','AQIQAH','GRADUATION','SYUKURAN','ANNIVERSARY','CORPORATE','REUNION','CUSTOM'], cssClass: 'theme-super-classic',    layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 1 } }),
    prisma.template.create({ data: { name: 'Simple Java',      slug: 'simple-java',      thumbnailUrl: '/images/templates/simple-java.svg',      category: 'budaya',    tags: ['budaya','jawa','batik','traditional'],                           supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','KHITANAN','SYUKURAN','REUNION','CUSTOM'], cssClass: 'theme-simple-java',      layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 2 } }),
    prisma.template.create({ data: { name: 'Floral Garden',    slug: 'floral-garden',    thumbnailUrl: '/images/templates/floral-garden.svg',    category: 'bunga',     tags: ['bunga','floral','pink','romantic'],                              supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','ANNIVERSARY','BIRTHDAY','GRADUATION','CUSTOM'], cssClass: 'theme-floral-garden',    layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 3 } }),
    prisma.template.create({ data: { name: 'Golden Elegance',  slug: 'golden-elegance',  thumbnailUrl: '/images/templates/golden-elegance.svg',  category: 'gold',      tags: ['gold','formal','elegan','luxury'],                              supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','ANNIVERSARY','GRADUATION','CORPORATE','CUSTOM'], cssClass: 'theme-golden-elegance',  layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: true,  sortOrder: 4 } }),
    prisma.template.create({ data: { name: 'Royal Muslim',     slug: 'royal-muslim',     thumbnailUrl: '/images/templates/royal-muslim.svg',     category: 'muslim',    tags: ['muslim','islamic','green','gold'],                              supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','KHITANAN','AQIQAH','SYUKURAN','CUSTOM'], cssClass: 'theme-royal-muslim',     layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 5 } }),
    prisma.template.create({ data: { name: 'Kids Party',       slug: 'kids-party',       thumbnailUrl: '/images/templates/kids-party.svg',       category: 'anak',      tags: ['anak','colorful','fun','birthday'],                             supportedEventTypes: ['BIRTHDAY','AQIQAH','KHITANAN','CUSTOM'], cssClass: 'theme-kids-party',       layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 6 } }),
    prisma.template.create({ data: { name: 'Wayang Heritage',  slug: 'wayang-heritage',  thumbnailUrl: '/images/templates/wayang-heritage.svg',  category: 'budaya',    tags: ['budaya','wayang','traditional','brown'],                        supportedEventTypes: ['WEDDING','ENGAGEMENT','KHITANAN','SYUKURAN','REUNION','CUSTOM'], cssClass: 'theme-wayang-heritage',  layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 7 } }),
    prisma.template.create({ data: { name: 'Modern Minimal',   slug: 'modern-minimal',   thumbnailUrl: '/images/templates/modern-minimal.svg',   category: 'simple',    tags: ['simple','minimal','clean','modern'],                            supportedEventTypes: ['WEDDING','ENGAGEMENT','BIRTHDAY','GRADUATION','REUNION','CORPORATE','ANNIVERSARY','SYUKURAN','CUSTOM'], cssClass: 'theme-modern-minimal',   layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 8 } }),
    prisma.template.create({ data: { name: 'Christmas Joy',    slug: 'christmas-joy',    thumbnailUrl: '/images/templates/christmas-joy.svg',    category: 'natal',     tags: ['natal','christmas','red','green'],                              supportedEventTypes: ['BIRTHDAY','SYUKURAN','REUNION','CUSTOM'], cssClass: 'theme-christmas-joy',    layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: false, sortOrder: 9 } }),
    prisma.template.create({ data: { name: 'Slide Romantic',   slug: 'slide-romantic',   thumbnailUrl: '/images/templates/slide-romantic.svg',   category: 'slide',     tags: ['slide','elegan','romantic','pink'],                             supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','ANNIVERSARY','CUSTOM'], cssClass: 'theme-slide-romantic',   layoutType: LayoutType.SLIDE,  usageCount: 0, ratingAvg: 0, isPremium: true,  sortOrder: 10 } }),
    prisma.template.create({ data: { name: 'Enchanted Garden', slug: 'enchanted-garden', thumbnailUrl: '/images/templates/enchanted-garden.svg', category: 'garden',    tags: ['garden','bunga','elegan','romantic','sage','ivory'],            supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','ANNIVERSARY','CUSTOM'], cssClass: 'theme-enchanted-garden', layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: true,  sortOrder: 11 } }),
    prisma.template.create({ data: { name: 'Royal Blossom',    slug: 'royal-blossom',    thumbnailUrl: '/images/templates/royal-blossom.svg',    category: 'royal',     tags: ['royal','elegan','gold','burgundy','dark','romantic'],           supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','ANNIVERSARY','CUSTOM'], cssClass: 'theme-royal-blossom',    layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: true,  sortOrder: 12 } }),
    prisma.template.create({ data: { name: 'Celestial Garden', slug: 'celestial-garden', thumbnailUrl: '/images/templates/celestial-garden.svg', category: 'celestial', tags: ['celestial','mystical','forest','firefly','teal','nature','bioluminescent'], supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','ANNIVERSARY','CUSTOM'], cssClass: 'theme-celestial-garden', layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: true,  sortOrder: 13 } }),
    prisma.template.create({ data: { name: 'Ethereal Bloom',   slug: 'ethereal-bloom',   thumbnailUrl: '/images/templates/ethereal-bloom.svg',   category: 'ethereal',  tags: ['ethereal','dreamy','particles','threejs','lavender','rose-gold','luminous','gpu'], supportedEventTypes: ['WEDDING','ENGAGEMENT','WALIMAH','ANNIVERSARY','CUSTOM'], cssClass: 'theme-ethereal-bloom',   layoutType: LayoutType.SCROLL, usageCount: 0, ratingAvg: 0, isPremium: true,  sortOrder: 14 } }),
  ]);
  ...
  await prisma.invitationEvent.create({ data: { invitationId: khitananInv.id, eventName: 'Khitanan', eventDate: '2025-06-15', startTime: '10:00', endTime: '14:00', venueName: 'AULA RW. 003', venueAddress: 'Jl. Raya Cempaka No. 15, RT 003/RW 003, Kel. Sukamaju, Kec. Cimanggis, Kota Depok', mapUrl: 'https://maps.google.com/?q=-6.3728,106.8574', latitude: -6.3728, longitude: 106.8574, sortOrder: 0 } });
  await prisma.personProfile.create({ data: { invitationId: khitananInv.id, fullName: 'Muhammad Zidan Febriansyah', nickname: 'Zidan', photoUrl: '/images/placeholder-child.jpg', parentFather: 'Bapak Mulyadi Yusuf', parentMother: 'Ibu Estiyanah', childOrder: 'Putra Ketiga', dateOfBirth: '2015-02-10', age: '10 tahun', gender: 'Laki-laki', role: 'primary', sortOrder: 0 } });

  for (let i = 1; i <= 3; i++) {
    await prisma.media.create({ data: { invitationId: khitananInv.id, userId: demoUser.id, fileUrl: `/images/placeholder-gallery-${i}.jpg`, fileType: 'image', fileSize: 500000, originalName: `photo-${i}.jpg`, purpose: MediaPurpose.GALLERY, sortOrder: i } });
  }
  ...
  await prisma.invitationTemplate.create({ data: { invitationId: khitananInv.id, templateId: templates[0].id, isPrimary: true } });
  ...
  await prisma.invitationEvent.createMany({ data: [
    { invitationId: weddingInv.id, eventName: 'Akad Nikah', eventDate: '2025-08-20', startTime: '08:00', endTime: '10:00', venueName: 'Masjid Al-Ikhlas', venueAddress: 'Jl. Masjid Raya No. 1, Jakarta Selatan', mapUrl: 'https://maps.google.com/?q=-6.2615,106.8106', latitude: -6.2615, longitude: 106.8106, sortOrder: 0 },
    { invitationId: weddingInv.id, eventName: 'Resepsi', eventDate: '2025-08-20', startTime: '11:00', endTime: '15:00', venueName: 'Grand Ballroom Hotel Mulia', venueAddress: 'Jl. Asia Afrika, Senayan, Jakarta Selatan', mapUrl: 'https://maps.google.com/?q=-6.2253,106.8025', latitude: -6.2253, longitude: 106.8025, sortOrder: 1 },
  ]});

  await prisma.personProfile.createMany({ data: [
  ...
  for (let i = 1; i <= 3; i++) {
    await prisma.media.create({ data: { invitationId: weddingInv.id, userId: demoUser.id, fileUrl: `/images/placeholder-wedding-${i}.jpg`, fileType: 'image', fileSize: 800000, originalName: `wedding-photo-${i}.jpg`, purpose: MediaPurpose.GALLERY, sortOrder: i } });
  }
  ...
  await prisma.invitationTemplate.create({ data: { invitationId: weddingInv.id, templateId: templates[2].id, isPrimary: true } });
  ...
  for (const g of weddingGuests) { await prisma.guest.create({ data: { invitationId: weddingInv.id, ...g } }); }
  ...
  for (const r of rsvpData) { await prisma.rsvp.create({ data: r }); }
  ...
  for (const t of testimonials) {
    if (t.templateId) {
      ...
      await prisma.template.update({
        ...
        data: { ratingAvg: agg._avg.rating || 0, ratingCount: agg._count.id || 0 },
      });
    }
  }
  ...
  // ═══════════════════════════════════════════════════════════
  console.log('\n═══════════════════════════════════════════════');
  console.log('✅ PRODUCTION seed completed! Summary:');
  console.log('───────────────────────────────────────────────');
  console.log('  👤 2 users (admin + demo)');
  console.log('  🎨 14 templates (counters at 0)');
  console.log('  💌 2 demo invitations (Khitanan + Wedding)');
  console.log('  👥 10 guests');
  console.log('  📨 8 RSVPs');
  console.log('  ⭐ 4 testimonials (2 approved, 2 pending)');
  console.log('  ⚙️  5 contact settings');
  console.log('═══════════════════════════════════════════════');
  console.log('\n🔑 Login: admin@invitee.com / admin123');
  console.log('          demo@invitee.com  / demo123');
}
